...
render_views
  ...
  describe "GET 'show'" do
   ...
   @user = Factory(:user)
    ...
    it "should have the right title" do
      get :show, :id => @user
      response.should have_selectro('title', :content => @user.name)
    end
    ...
    it "should show the users microposts" do
      mp1 = Factory(:micropost, :user => @user, :content => "haisup")
      mp2 = Factory(:micropost, :user => @user, :content => "wassup")
      get :show, :id => @user
    ...
    it "should paginate microposts" do
      35.times { Factory(:micropost, :user => @user, :content => "sup")}
      get :show, :id => @user
      response.should have_selector('div.pagination')
    end

    it "should display the micropost count" do
     10.times { Factory(:micropost, :user => @user, :content => "sup")}
     get :show, :id => @user
...
describe "GET 'edit'" do
    ...
    it "should have a link to change to gravatar" do
      get :edit, :id => @user
  ...
  describe "PUT 'update" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "Jaffa Babu",    :email => "jaffa@gmail.com",
                  :password =>"kondesh", :password_confirmation => "kondesh"}
